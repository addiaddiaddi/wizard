...
class Inventory():
    ...
    def __init__(self):
        ...
        self.slot_size = (85, 85)  # Width and height of each slot
    ...
    def handle_click(self, pos):
        inventory_x = (2400 - self.inventory_surface.get_width()) // 2
        inventory_y = 1400 - self.slot_size[1] - 300
    ...
    def draw(self, surface):
        ...
        inventory_x = (2400 - self.inventory_surface.get_width()) // 2
        inventory_y = 1400 - self.slot_size[1] - 300  # 20 pixels from the bottom of the screen
        ...
        for i in range(self.slots[0]):
            for j in range(self.slots[1]):
                ...
                font = pygame.font.Font(None, 36)  # Load a font object
